public class HeronsFormula {
  ...
  // This function computers the area of a triangle with side lengths a, b, & c.
  public static double triangleArea( int a, int b, int c ) {
      ...
      // 1. The version that does not use functions is longer.
      // 2. The change would have had to occur in every block of code in which the triangle sides
      // are displayed in the version with no function.
      // 3. Adding test with triangle sides 9,9,9 was not difficult - this would have been
      // difficult in version without function as every value needs to be repeated, as well as
      // s formula and area formula
}
}
